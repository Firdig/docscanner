<x-app-layout>
  {{-- Header: dibuat ringkas agar sejajar dengan sidebar --}}
  <x-slot name="header">
    <div class="flex items-center justify-between">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Storage</h2>
    </div>
  </x-slot>
  ...
  <style>
    /* ===========================
       RATKAN HEADER DENGAN SIDEBAR
       =========================== */
    /* Jetstream/Breeze biasanya: <header class="bg-white shadow"><div class="... py-6 ..."> */
    header.bg-white.shadow > div {
      padding-top: .5rem !important;   /* semula ~1.5rem */
      padding-bottom: .5rem !important;
    }
    /* Sedikit kurangi jarak atas konten utama halaman ini */
    .doc-index-wrapper {
      padding-top: .5rem;  /* semula py-6 -> pt-2 kira-kira */
      padding-bottom: 1.5rem;
    }

    /* --- tombol: pastikan tidak ketimpa reset CSS --- */
    .btn{
    ...
    .btn-action{
      height:30px;width:75px;padding:0 .75rem;box-sizing:border-box;
    }
  </style>

  {{-- Wrapper konten: pt dikurangi agar lebih dekat ke header --}}
  <div class="doc-index-wrapper">
    <div class="max-w-7xl mx-auto px-6 space-y-4">
      ...
      <form method="GET" action="{{ route('documents.index') }}" class="bg-white p-4 rounded-xl shadow space-y-3">
        ...
        {{-- Baris 2: Kategori (kiri) + Unggah (kanan) --}}
            ...
            <tr class="border-b hover:bg-gray-50">
              ...
              <td class="px-3 py-2">
                <div class="flex gap-3">
                  <a href="{{ route('documents.show',$doc) }}" class="btn btn-action btn-preview">Preview</a>
                  <a href="{{ route('documents.download',$doc) }}" class="btn btn-action btn-download">Download</a>
                  <a href="{{ route('documents.edit',$doc) }}" class="btn btn-action btn-edit">Edit</a>
